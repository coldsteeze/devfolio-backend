...
public class ApiError {
    ...
    @Schema(example = "Nickname already exists", description = "Detailed error message")
    private String message;

    @Schema(example = "NICKNAME_ALREADY_EXISTS", description = "Application specific error code")
    private String code;

    @Schema(example = "/api/profiles", description = "Path of the endpoint that caused the error")
    private String path;
